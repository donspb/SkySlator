...
object Config {
    const val application_id = "ru.donspb.skyslator"
...
object Design {
    const val appcompat = "amdroidx.appcompat:appcompat:${Versions.appcompat}"
...
object Koin {
    ...
    const val koin_android_compat = "org.koin:koin-android-compat:${Versions.koinAndroid}"
